...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="mb-3 breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('staffs.nhanviens.index') }}">Danh sách nhân viên</a>
            </li>
            <li class="separator">
                <i class="icon-arrow-right"></i>
            </li>
            <li class="nav-item">
                <a href="{{ route('staffs.nhanviens.archived') }}">Danh sách nhân viên nghỉ</a>
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="bulk-restore-form" action="{{ route('staffs.nhanviens.restore.bulk') }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="flex-wrap gap-2 mb-3 d-flex align-items-center">
                            ...
                            <a href="{{ route('staffs.nhanviens.index') }}" class="btn btn-success">Danh sách nhân viên</a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            <td colspan="9" class="text-center">
                                                ...
                                                @else
                                                    ...
                                                    <br>
                                                    <a href="{{ route('staffs.nhanviens.index') }}" class="mt-3 btn btn-primary">
