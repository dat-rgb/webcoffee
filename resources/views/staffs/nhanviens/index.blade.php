        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="bulk-archive-form" action="{{ route('staffs.nhanviens.archive.bulk') }}" method="POST">
                        @csrf
                        @method('PATCH')
                            <div class="card-header">
                                <div class="flex-wrap gap-2 mb-3 d-flex align-items-center">
                                    <a href="{{ route('staffs.nhanviens.lich.showForm') }}" class="btn btn-info">Phân công lịch làm việc</a>
                                    <a href="{{ route('staffs.nhanviens.lich.tuan') }}" class="btn btn-success">Lịch làm việc</a>
                                </div>
                            </div>
                            <div class="card-body">
                                                            ...
                                                            <tr>
                                                                <td colspan="9" class="text-center">
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <br>
                                                                        <a href="{{ route('staffs.nhanviens.create') }}" class="mt-3 btn btn-primary">
                                                        ...
                                                        @else
                                                            @foreach ($nhanViens as $index => $nv)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $nv->dia_chi }}</td>
                                                                    <td>
                                                                        <a href="{{ route('staffs.nhanviens.edit', $nv->ma_nhan_vien) }}" class="btn btn-sm btn-warning">
                                                                            Sửa
                                                                        </a>
                                                                    </td>
                                                                </tr>
